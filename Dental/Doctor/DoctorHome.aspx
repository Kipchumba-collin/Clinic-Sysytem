...
<asp:Content ID="Content2" ContentPlaceHolderID="Cp1" runat="server">
    <p>The hospital runs a fully equipped and modern dental clinic offering a full range of dental services.</p>
    
    <p>Among our services include: </p> 
<p><b> Diagnosis of dental conditions</b></p>
   
   <ol>
  <li>Dental X-rays</li>
  <li>Tooth extraction</li>
  <li>All types of fillings</li>
<li>Root canal treatment</li>
       <li>Temporary and permanent crowns</li>
</ol>
 ...
 <style>
        ...
        ol{
            list-style-type: decimal; /* Set the list style type to numbers */
