 <%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="None"  CodeBehind ="DoctorRegistrationForm.aspx.cs" Inherits="Dental.DoctorRegistrationForm" %>
                ...
                <div class="container grad">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h1><strong>Neema Clinic</strong> Dentist Registration</h1>
                                     ...
                                     <asp:CustomValidator runat="server" Display="Dynamic" ControlToValidate="Email"    ID="DV"  
                                         ...
                                         <div class="form-group">
                                             ...
                                             <asp:DropDownList ID="Department" runat="server" Width="228px" Height="39px">
                                                 ...
                                                 <asp:ListItem Text="Oral Surgery" Value="1"></asp:ListItem>
                                                 <asp:ListItem Text="Implantory" Value="2"></asp:ListItem>
                                                 <asp:ListItem Text="Orthodonthics" Value="3"></asp:ListItem>
                                                 <asp:ListItem Text="Prosthetics" Value="4"></asp:ListItem>
                                                 <asp:ListItem Text="Restorative Dentistry" Value="5"></asp:ListItem>
